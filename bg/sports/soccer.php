<?php 
    ...
    $last_name6 = $_POST['lname6'];
			...
			if($from1 == '' or $first_name1 == '' or $last_name1 == '' or $first_name2 == '' or $last_name2 == '' or $first_name3 == '' or $last_name3 == '' or $first_name4 == '' or $last_name4 == '' or $first_name5 == '' or $last_name5 == '' or $first_name6 == '' or $last_name6 == '') {
  			 echo "Error";
   				exit();
   				} else {
   				 $subject = "Soccer";
  				  $message = $first_name1 . " " . $last_name1 . "\n" . $first_name2 . " " . $last_name2. "\n" . $first_name3 . " " . $last_name3. "\n" . $first_name4 . " " . $last_name4. "\n" . $first_name5 . " " . $last_name5. "\n" . $first_name6 . " " . $last_name6;
